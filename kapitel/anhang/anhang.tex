...
Der Judge-Prompt für Stufe~5 (Self-Improvement-Loop) ist mit dem Prompt der
Stufen~1--4 (Anhang~\ref{app:judge-prompt-base}) identisch; die
Bewertungsskalen und der Output bleiben unverändert. Abweichend sind lediglich
